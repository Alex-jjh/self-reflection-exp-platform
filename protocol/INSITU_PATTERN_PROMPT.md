# In-situ Pattern 提取 Prompt（捐赠分层中间档，v1）
...
>
> **状态：v1（2026-08-07 校准后定稿），可进协议**（附使用规则，
...
2. 我的提问方式统计（请求不算问题，比如"帮我看看X""你再帮我
   想想Y"这类祈使句不计入 a 也不计入 b）：
...
2. My question styles (requests are not questions — imperatives like
   "help me look at X" or "give me more ideas for Y" count for neither
   a nor b):
...
4. Position changes:
   ...
   b. Did I ever defend my original account against your differing
      ...
      I am"). How many times? Quote each briefly.
